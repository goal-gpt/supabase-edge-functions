...
export const WEEKLY_EMAIL_PREMISE =
  ...
  `6. Before ending the email, invite the client to pay GBP 3 for the next week of the program and include a button with: ` +
  `a. rounded corners; ` +
  `b. the background-color #FFCB31; ` +
  `c. the font color #ffffff; ` +
  `d. the text "Pay for Week 2"; and ` +
  `e. the link, "https://buy.stripe.com/dR62c5flt9nu8qk3cc". ` +
